...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_helios/modules/title_screen/icons/skyrat_title_screen.png' // HELIOS EDIT - CHANGE - PREVIOUS: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_helios/modules/title_screen/icons/loading_screen.gif' // HELIOS EDIT - CHANGE - PREVIOUS: 'modular_skyrat/modules/title_screen/icons/loading_screen.gif'
